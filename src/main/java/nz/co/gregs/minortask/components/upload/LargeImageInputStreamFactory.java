 ...
 */
public class LargeImageInputStreamFactory implements InputStreamFactory {
	
	private final Document doc;
	private double targetSize = 200d;

	public LargeImageInputStreamFactory(Document doc) {
		this.doc = doc;
	}
	public LargeImageInputStreamFactory(Document doc, double targetSize) {
		this.doc = doc;
